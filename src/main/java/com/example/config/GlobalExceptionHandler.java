...
public class GlobalExceptionHandler {
    ...
    public String accessDeniedExceptionHandler(AccessDeniedException ex) {
        System.out.println("hahhahahahahhahahahhahahha");
        return resultFormat(1, ex);
    }
    ...
    public String requestTypeMismatch() {
        return requestTypeMismatch();
    }
    ...
    private <T extends Throwable> String resultFormat(Integer code, T ex) {
        ...
        return new Response(code, ex.getMessage()).toString();
    }
}
